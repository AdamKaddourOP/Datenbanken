...
public class CLApplication {
    ...
    public static void main(String[] args) {
        ...
        database.setJdbcUrl("jdbc:postgresql://localhost:5432/postgres");
		...
		database.dbQuery("CREATE SCHEMA IF NOT EXISTS versuch5;");
		database.dbQuery("set SEARCH_PATH to versuch5;");
